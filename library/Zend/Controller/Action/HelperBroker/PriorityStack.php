...
class Zend_Controller_Action_HelperBroker_PriorityStack implements IteratorAggregate, ArrayAccess, Countable
{
     ...
     * @return Zend_Controller_Action_HelperBroker_PriorityStack
     */
    public function offsetExists(mixed $priorityOrHelperName): bool
    {
     ...
     * @return Zend_Controller_Action_HelperBroker_PriorityStack
     */
    public function offsetGet(mixed $priorityOrHelperName): mixed
    {
     ...
     * @return Zend_Controller_Action_HelperBroker_PriorityStack
     */
    public function offsetUnset(mixed $priorityOrHelperName): void
    {
        if (!$this->offsetExists($priorityOrHelperName)) {
            require_once 'Zend/Controller/Action/Exception.php';
